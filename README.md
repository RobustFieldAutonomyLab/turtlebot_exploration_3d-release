## turtlebot_exploration_3d (indigo) - 0.0.10-2

The packages in the `turtlebot_exploration_3d` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo turtlebot_exploration_3d` on `Tue, 03 Apr 2018 22:12:16 -0000`
...
## turtlebot_exploration_3d (indigo) - 0.0.10-1

The packages in the `turtlebot_exploration_3d` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo turtlebot_exploration_3d` on `Tue, 03 Apr 2018 22:06:11 -0000`
...
## turtlebot_exploration_3d (indigo) - 0.0.10-0

The packages in the `turtlebot_exploration_3d` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo turtlebot_exploration_3d` on `Tue, 03 Apr 2018 22:04:16 -0000`
...
## turtlebot_exploration_3d (indigo) - 0.0.9-0

The packages in the `turtlebot_exploration_3d` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo turtlebot_exploration_3d` on `Sun, 05 Feb 2017 03:43:17 -0000`
...
## turtlebot_exploration_3d (indigo) - 0.0.8-0

The packages in the `turtlebot_exploration_3d` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo turtlebot_exploration_3d` on `Tue, 03 Jan 2017 23:38:38 -0000`
...
## turtlebot_exploration_3d (indigo) - 0.0.7-0
